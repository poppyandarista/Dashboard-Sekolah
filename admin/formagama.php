            ...
            <div class="col-md-9">
              ...
              <div class="card card-primary card-outline mb-4">
                ...
                <div class="card-header">
                  <div class="card-title">Form Tambah Agama</div>
                </div>
                <!--end::Header-->
                <!--begin::Form-->
                <form action="" method="post" class="needs-validation" novalidate>
                  ...
                  <div class="card-body">
                    <div class="mb-3">
                      <label for="exampleInputPassword1" class="form-label">Nama Agama</label>
                      <input type="text" class="form-control" id="namaagama" name="namaagama" required />
                      <div class="invalid-feedback">Nama Agama wajib diisi.</div>
                    </div>
                  </div>
                  <!--end::Body-->
                  <!--begin::Footer-->
