...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
            ...
            <div class="col-lg-5 connectedSortable">
              <div class="card mb-4">
                ...
                <div class="card-body d-flex justify-content-center align-items-center">
                  <div id="user-role-chart" style="min-width: 200px; width: 100%; max-width: 400px;"></div>
                </div>
              </div>
            </div>
            <!-- /.Start col -->
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
      ...
      // Chart Distribusi Pengguna
      if (document.querySelector('#user-role-chart')) {
        const userRoleData = {
        ...
        const user_role_chart_options = {
          ...
          chart: {
            type: 'donut',
            height: 320, // Sedikit menambah tinggi default jika perlu
            // width: '100%' // Biarkan chart mengisi container secara default
          },
          labels: userRoleData.labels,
          colors: ['#0d6efd', '#20c997', '#fd7e14'],
          legend: {
            position: 'bottom', // Default posisi legenda
            horizontalAlign: 'center', // Pastikan legenda juga tengah
            offsetY: 5 // Beri sedikit jarak dari chart
          },
          responsive: [{
            breakpoint: 768, // Untuk tablet dan layar lebih kecil
            options: {
              chart: {
                // Tidak perlu set width di sini, biarkan mengisi container
                // Anda bisa sesuaikan height jika perlu
                height: 280
              },
              legend: {
                position: 'bottom',
                // fontSize: '12px' // Kecilkan font legenda jika perlu
              },
              plotOptions: { // Sesuaikan ukuran label total untuk layar lebih kecil
                pie: {
                  donut: {
                    labels: {
                      total: {
                        fontSize: '16px',
                        label: 'Total' // Label lebih singkat
                      }
                    }
                  }
                }
            ...
            breakpoint: 480, // Untuk HP
            options: {
              chart: {
                // Tidak perlu set width di sini, biarkan mengisi container
                height: 250 // Perkecil tinggi untuk HP
              },
              legend: {
                position: 'bottom',
                // fontSize: '10px' // Lebih kecil lagi font legenda
              },
              plotOptions: {
                pie: {
                  donut: {
                    labels: {
                      show: true, // Tetap tampilkan
                      name: { // Sembunyikan nama seri individu di tengah jika terlalu ramai
                        // show: false 
                      },
                      value: { // Tampilkan hanya nilai total
                        // show: false
                      },
                      total: {
                        show: true,
                        fontSize: '14px', // Ukuran font total untuk HP
                        label: 'Total' // Label lebih singkat
                      }
                    }
                  }
            ...
            pie: {
              donut: {
                labels: {
                  ...
                  total: {
                    show: true,
                    fontSize: '18px', // Ukuran font default untuk label total
                    label: 'Total Pengguna', // Label default
      ...
      // World map by jsVectorMap (jika diperlukan)
      ...
      // Hapus kode sparkline jika tidak digunakan
      // Karena tidak ada elemen dengan id sparkline-1, sparkline-2, sparkline-3 di HTML
    });
  </script>
  <!--end::Script-->
</body>
