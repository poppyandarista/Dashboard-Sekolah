        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-5">
              <div class="card mb-4">
                ...
                <div class="card-body p-0 table-responsive">
                  <table id="dataAgama" class="display nowrap" style="width:100%">
                    <thead>
                      <tr>
                        <th style="width: 10px">ID Agama</th>
                        <th>Nama Agama</th>
                        <th>Opsi</th>
                      </tr>
                    </thead>
                    <tbody>
                      ...
                      foreach ($db->tampil_data_agama() as $x) {
                        ...
                        <tr class="align-middle">
                          ...
                          <td>
                            <button onclick="showEditAgamaForm('<?php echo $x['idagama']; ?>')"
                              class="btn btn-success btn-sm">Edit</button>
                            <a href="#"
                              onclick="confirmDeleteAgama('<?php echo $x['idagama']; ?>', '<?php echo $x['namaagama']; ?>')"
              ...
              <!-- /.card -->
              <a href="formagama.php" class="btn btn-primary">Tambah Data</a>
            </div>
            <!-- /.col -->
          </div>
          <!--end::Row-->
